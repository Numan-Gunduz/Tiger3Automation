...
Scenario Outline: Kullanıcı eksik bilgi bulunan fişi düzenler ve kaydeder
  ...
  | Ekstre Aktarımı | Ziraat Bankası | TR0300**5013 - ZİRAAT   | 28             | Listele       | Eksik Bilgi Bulunuyor | Kaydedilebilir | Fiş Türü Değiştir  | Banka İşlem Fişi          |                            | Kaydedilebilir         | Kaydedilebilir | Fiş İncele     |
  | Ekstre Aktarımı | Ziraat Bankası | TR0300**5013 - ZİRAAT   | 28             | Listele       | Eksik Bilgi Bulunuyor | Kaydedilebilir | Fiş Türü Değiştir  | Hizmet Faturası Fişi      | ERP Hizmet Kodu            | Eksik Bilgi Bulunuyor  | Kaydedilebilir | Fiş İncele     |
  | Ekstre Aktarımı | Ziraat Bankası | TR0300**5013 - ZİRAAT   | 28             | Listele       | Eksik Bilgi Bulunuyor | Kaydedilebilir | Fiş Türü Değiştir  | Virman Fişi               | ERP Banka Hesap Kodu       | Eksik Bilgi Bulunuyor  | Kaydedilebilir | Fiş İncele     |
  | Ekstre Aktarımı | Ziraat Bankası | TR0300**5013 - ZİRAAT   | 28             | Listele       | Eksik Bilgi Bulunuyor | Kaydedilebilir | Fiş Türü Değiştir  | Havale/EFT Fişi           | ERP Cari Hesap Kodu        | Eksik Bilgi Bulunuyor  | Kaydedilebilir | Fiş İncele     |
  ...
  Scenario: Tutarı negatif olan Kredi Kartı Ödeme Fişi kaydının seçilmesi ve fiş oluşturulması
    ...
    And Kullanıcı başlangıç tarihi olarak bugünden 28 gün önceki tarihi girer
